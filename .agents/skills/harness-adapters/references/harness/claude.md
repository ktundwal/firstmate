...
On native Windows, matching PowerShell entries use `../../../bin/fm-claude-hook-launch.ps1` to invoke the same shared scripts through Git Bash without changing their exit semantics.
