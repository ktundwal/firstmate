...
secondmate_liveness_one() {  # <meta> <id>
  ...
  case "$harness" in
    claude|codex|copilot|opencode|pi|pi-signed|grok|kimi|omp) ;;
    *)
...
crew_dispatch_validate() {
  ...
  if $typed_active; then
    ...
    verified_harnesses='["claude","codex","copilot","opencode","pi","pi-signed","grok","kimi","cursor","agy","muse","rovo","omp"]'
  fi
