...
family_for_basename() {
  case "$1" in
    ...
    fm-herdr-windows-cwd.test.sh|fm-herdr-windows-literal.test.sh|fm-herdr-windows-socket.test.sh|\
    ...
    fm-claude-hook-launch.test.sh|fm-windows-copilot-session.test.sh|\
    fm-tasks-axi-windows.test.sh|fm-windows-private-path.test.sh|fm-windows-process.test.sh)
      printf '%s\n' live-harness-optin
      ;;
...
tests/fm-claude-hook-launch.test.sh 30000
tests/fm-copilot-harness.test.sh 150000
tests/fm-copilot-primary-live-e2e.test.sh 300000
tests/fm-herdr-windows-cwd.test.sh 30000
tests/fm-herdr-windows-literal.test.sh 30000
tests/fm-herdr-windows-socket.test.sh 30000
...
tests/fm-tasks-axi-windows.test.sh 30000
...
tests/fm-windows-copilot-session.test.sh 30000
tests/fm-windows-private-path.test.sh 30000
tests/fm-windows-process.test.sh 30000
...
families_for_changed_path() {
  ...
  case "$path" in
    tests/fm-backend-herdr-eventwait.test.py)
      ...
      printf '%s\n' backend-dispatch
      ;;
    tests/fm-windows-process.test.ps1)
      printf '%s\n' __script__:fm-windows-process.test.sh
      ;;
    tests/fm-windows-private-path.test.ps1)
      printf '%s\n' __script__:fm-windows-private-path.test.sh
      ;;
    bin/fm-copilot-hook.sh|bin/fm-copilot-worker-hook.sh|\
    bin/fm-copilot-watcher-receipt-lib.sh|bin/fm-harness-process-lib.sh|\
    bin/fm-windows-process-lib.sh|bin/fm-windows-process.ps1)
      printf '%s\n' __script__:fm-copilot-harness.test.sh
      printf '%s\n' backend-dispatch
      printf '%s\n' live-harness-optin
      ;;
    bin/fm-private-path-lib.sh|bin/fm-windows-private-path.ps1|\
    bin/fm-claude-compat-hook.sh|bin/fm-claude-hook-launch.ps1)
      printf '%s\n' __script__:fm-copilot-harness.test.sh
      printf '%s\n' live-harness-optin
      ;;
    tests/*.test.sh)
