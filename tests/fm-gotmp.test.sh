...
SH
  ...
  ln -s "$ROOT/bin/fm-harness-process-lib.sh" "$fake/bin/fm-harness-process-lib.sh"
  ln -s "$ROOT/bin/fm-windows-process-lib.sh" "$fake/bin/fm-windows-process-lib.sh"
  ln -s "$ROOT/bin/fm-windows-process.ps1" "$fake/bin/fm-windows-process.ps1"
